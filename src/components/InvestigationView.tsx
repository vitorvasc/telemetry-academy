    ...
    <div className="h-full flex flex-col">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div>
            <span
              className={`text-xs font-bold uppercase tracking-widest mr-3 ${solved ? 'text-green-400' : 'text-red-400'}`}
            >
        ...
        <div className="flex items-center gap-4 text-[10px] text-slate-500">
          ...
          <span
            className={`font-mono font-semibold ${solved ? 'text-green-400' : 'text-amber-400'}`}
          >
      ...
      <div className="flex-1 overflow-hidden">
        {/* Traces Tab */}
        <div
          style={{ display: activeTab === 'traces' ? 'block' : 'none' }}
          className="h-full"
        >
          <TraceViewer
            spans={data.spans}
        ...
        {/* Root Cause Tab */}
        <div
          style={{ display: activeTab === 'rootcause' ? 'block' : 'none' }}
